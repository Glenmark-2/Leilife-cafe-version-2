...
$routes = include __DIR__ . '/../backend/config/admin_routes.php';
...
include __DIR__ . '/../components/admin/nav_bar.php';
...
echo '<script src="../scripts/admin/' . htmlspecialchars($page) . '.js"></script>';
